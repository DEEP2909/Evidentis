...
const configSchema = z.object({
  ...
  INDIANKANOON_BASE_URL: z.string().url().default('https://api.indiankanoon.org'),
  ...
  DATA_PROTECTION_OFFICER_EMAIL: z.string().email().default('dpo@evidentis.tech'),
  DPDP_CONSENT_VERSION: z.string().default('1.0'),
  DATA_RESIDENCY_REGION: z.enum(['centralindia', 'ap-mumbai-1']).default('centralindia'),
