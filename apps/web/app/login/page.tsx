      ...
      >
        ...
        <div className="space-y-6">
          <h1 className="text-4xl font-bold text-white leading-tight">
            India-Ready Legal
            <br />
            <span className="text-[hsl(var(--gold))]">Intelligence Platform</span>
          </h1>
          <p className="text-lg text-gray-300 max-w-md">
            Run multilingual legal operations with intelligent document analysis,
            bare acts research, and advocate workflows across all Indian states and UTs.
          </p>
        </div>

        <div className="flex items-center gap-8">
          <div>
            <p className="text-3xl font-bold text-[hsl(var(--gold))]">13</p>
            <p className="text-sm text-gray-400">Languages</p>
          </div>
          <div>
            <p className="text-3xl font-bold text-[hsl(var(--gold))]">36</p>
            <p className="text-sm text-gray-400">Jurisdictions</p>
          </div>
          <div>
            <p className="text-3xl font-bold text-[hsl(var(--gold))]">DPDP</p>
            <p className="text-sm text-gray-400">Aligned</p>
          </div>
        </div>
      </motion.div>
